...
using workspace.YU__FFE.Scripts.Commons.workspace.YU__FFE.Scripts.Commons;
...
namespace workspace.YU__FFE.Scripts.Networking {
    public class SignInHandler : Singleton<SignInHandler> {
        ...
        public void TrySignIn(string id, string password, Action<bool, string> callback) {
            ...
            if (!ValidationManager.Validate("email", id)) return;

            if (!ValidationManager.Validate("password", password)) ;
