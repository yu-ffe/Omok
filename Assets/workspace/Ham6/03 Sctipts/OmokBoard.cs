...
public class OmokBoard : MonoBehaviour
{
    ...
    public Vector2 originalBoardSize = new Vector2(692, 692); // 원본 바둑판 이미지 크기
    public float originalPadding = 30f; // 원본 공백 크기
    public GameObject MakerBlackPrefab; // 흑바둑알 프리팹
    public GameObject MakerWhitePrefab; // 백바둑알 프리팹
